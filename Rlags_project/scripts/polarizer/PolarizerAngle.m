function [CODE] = PolarizerAngle(Lat,Long,GMT,day,Mimu)
...
LST = 10.193 + dDay*0.0656 + frac(dDay)*24 - Long/15;  % units of hours
magDec = 7.72 + (Long - 104.246)*0.407;                 % units of degrees
