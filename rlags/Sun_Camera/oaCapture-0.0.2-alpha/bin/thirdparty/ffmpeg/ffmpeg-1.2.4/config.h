...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local/openastro --enable-memalign-hack --enable-static --enable-shared --disable-debug --disable-programs --disable-network --disable-encoders --enable-encoder=utvideo --enable-encoder=rawvideo --disable-doc --disable-muxers --enable-muxer=avi --disable-bsfs --disable-indevs --disable-protocols --enable-protocol=file"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define FFMPEG_DATADIR "/usr/local/openastro/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/openastro/share/ffmpeg"
