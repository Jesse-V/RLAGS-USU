...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr/local/openastro --enable-memalign-hack --enable-static --enable-shared --disable-debug --disable-programs --disable-network --disable-encoders --enable-encoder=utvideo --enable-encoder=rawvideo --disable-doc --disable-muxers --enable-muxer=avi --disable-bsfs --disable-indevs --disable-protocols --enable-protocol=file
...
EXTRALIBS=-lasound -lm -pthread -lz -lrt 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
